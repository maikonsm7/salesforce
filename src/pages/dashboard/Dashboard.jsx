    ...
    return (
        <>
            <div className="m-auto" style={{ maxWidth: '95%' }}>
                ...
                <div className="border rounded-2 p-2 mx-1 pb-5" style={{ height: 250 }}>
                ...
                <div className="row p-3" style={{ height: 300 }}>
                    ...
                    <div className="col border text-center me-3 p-2 rounded-2">
                    ...
                    <div className="col border rounded-2 p-2">
                        ...
                        <div className="row row-cols-md-2 mt-3 p-2" style={{fontSize: '10pt'}}>
                            <div className="col">
                                <DashProduct prod={"Emp. Consignado"} value={"220.000,00"} />
                                <DashProduct prod={"Abertura de conta"} value={8} />
                                <DashProduct prod={"Cartão de crédito"} value={4} />
                            </div>

                            <div className="col">
                                <DashProduct prod={"Lime"} value={7} />
                                <DashProduct prod={"Cheque Especial"} value={3} />
                                <DashProduct prod={"Microseguro"} value={10} /> 
                            </div>
                        </div>
